        ...
        class PerturbedAttentionScript(scripts.Script):
            ...
            def ui(self, *args, **kwargs):
                with gr.Accordion(open=False, label=self.title()):
                    ...
                    adaptive = gr.Slider(label="Adaptive Scale", minimum=0.0, maximum=1.0, step=0.01, value=0.0)
                    with gr.Row():
                ...
                return enabled, scale, adaptive, block, block_id

            def process_before_every_sampling(self, p, *script_args, **kwargs):
                enabled, scale, block, block_id = script_args
                ...
                unet = opPerturbedAttention.patch(unet, scale, adaptive, block, block_id)[0]
